...
I use [Sublime Text](https://www.sublimetext.com/) to edit it, and the [MarkdownPreview](https://packagecontrol.io/packages/MarkdownPreview) package to render it to html (using the integrated markdown parser, not the github one). You need to override these settings of the MarkdownPreview package:
```json
{
...
```
To render the rulebook (.md + .css -> .html) in Sublime:
